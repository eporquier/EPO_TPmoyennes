...
namespace TPMoyennes
{
    ...
    internal class Eleve
    {
        ...
        public double moyenneGeneral()
        {
            ...
            double resultatGeneral = totalGeneral / matieresEleve.Count;
            return double.Round(resultatGeneral, 2);
        }
    }
}
